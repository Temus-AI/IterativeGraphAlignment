# Custome DataCollator which fixes the issue of previous version
...
def get_query_prompt_format_func(tokenizer):
    def formatting_query_prompt_func(example):
        ...
        for prompt, completion in zip(example['prompt'], example['completion']):
            ...
            output_texts.append(query_prompt)
        return output_texts
    return formatting_query_prompt_func
